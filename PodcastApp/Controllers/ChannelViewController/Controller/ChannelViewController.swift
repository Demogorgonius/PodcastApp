...
class ChannelViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        delegate?.didSelectCell(withId: id, allEpisodes: allEpisodes, podcastName: self.podcast?.title ?? "")
//        let playerVC = PlayerViewController(with: episodes!, podcastName: self.podcast?.title)
